...
/**
  ...
  */
class xR2RMLTable(val tableName: String, override val listPushDown:List[xR2RMLPushDown])
  extends xR2RMLLogicalSource(Constants.LogicalTableType.TABLE_NAME, Constants.xR2RML_REFFORMULATION_COLUMN
      , None, Set.empty, listPushDown) {
