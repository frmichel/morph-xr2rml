...
object MorphSQLUtility {
  ...
  def getSelectItemByAlias(alias: String, selectItems: Iterable[ZSelectItem], prefix: String): Option[ZSelectItem] = {
  ...
  def getSelectItemsByAliasJava(selectItems: java.util.Collection[ZSelectItem], alias: String): java.util.Collection[ZSelectItem] = {
    this.getSelectItemsByAlias(selectItems.toList, alias);
  }

  def getSelectItemsByAlias(selectItems: Iterable[ZSelectItem], alias: String): List[ZSelectItem] = {
  ...
  def getSelectItemsMapPrefixJava(selectItems: java.util.Collection[ZSelectItem], node: Node, pPrefix: String, dbType: String): java.util.Collection[ZSelectItem] = {
    this.getSelectItemsMapPrefix(selectItems, node, pPrefix, dbType);
  }

  def getSelectItemsMapPrefix(selectItems: Iterable[ZSelectItem], node: Node, pPrefix: String, dbType: String): Iterable[ZSelectItem] = {
  ...
  def pushOrderByDownJava(oldOrderByCollection: List[ZOrderBy], mapInnerAliasSelectItem: Map[String, ZSelectItem]): List[ZOrderBy] = {
    this.pushOrderByDown(oldOrderByCollection.toList, mapInnerAliasSelectItem.toMap);
  }

  def pushOrderByDown(oldOrderByCollection: List[ZOrderBy], mapInnerAliasSelectItem: Map[String, ZSelectItem]): List[ZOrderBy] = {
